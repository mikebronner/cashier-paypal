...
namespace GeneaLabs\CashierPaypal\Tests\Fixtures;

use GeneaLabs\CashierPaypal\Billable;
use Illuminate\Database\Eloquent\Model;
use GeneaLabs\CashierPaypal\Order\Contracts\ProvidesInvoiceInformation;
