...
use GeneaLabs\CashierPaypal\Order\Tax;
use GeneaLabs\CashierPaypal\Order\TaxCollection;
...
class OrderItemCollectionTest extends BaseTestCase
{
    ...
    public function testChunkByOwner()
    {
        ...
        $this->assertEquals([
            'GeneaLabs\CashierPaypal\Tests\Fixtures\User_1',
            'GeneaLabs\CashierPaypal\Tests\Fixtures\User_2',
        ], $result->keys()->all());
    ...
    public function testChunkByOwnerAndCurrency()
    {
        ...
        $this->assertEquals([
            'GeneaLabs\CashierPaypal\Tests\Fixtures\User_1_USD',
            'GeneaLabs\CashierPaypal\Tests\Fixtures\User_2_EUR',
            'GeneaLabs\CashierPaypal\Tests\Fixtures\User_2_USD',
        ], $result->keys()->all());
    }
