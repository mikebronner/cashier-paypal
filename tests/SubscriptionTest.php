...
class SubscriptionTest extends BaseTestCase
{
    ...
    public function yieldsOrderItemsAtSetIntervals()
    {
        ...
        $this->assertSame("GeneaLabs\CashierPaypal\Subscription", $item_1->orderable_type);
        $this->assertSame("GeneaLabs\CashierPaypal\Tests\Fixtures\User", $item_1->owner_type);
        ...
        $this->assertSame("GeneaLabs\CashierPaypal\Subscription", $item_2->orderable_type);
        $this->assertSame("GeneaLabs\CashierPaypal\Tests\Fixtures\User", $item_2->owner_type);
        ...
        $this->assertSame("GeneaLabs\CashierPaypal\Subscription", $item_3->orderable_type);
        $this->assertSame("GeneaLabs\CashierPaypal\Tests\Fixtures\User", $item_3->owner_type);
