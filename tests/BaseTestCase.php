...
use GeneaLabs\CashierPaypal\Coupon\FixedDiscountHandler;
use GeneaLabs\CashierPaypal\Tests\Database\Migrations\CreateUsersTable;
use GeneaLabs\CashierPaypal\Tests\FirstPayment\Actions\StartSubscriptionTest;
...
abstract class BaseTestCase extends TestCase
{
    ...
    {
        return ['GeneaLabs\CashierPaypal\CashierServiceProvider'];
    }
    ...
    {
        config(['cashier.billable_model' => 'GeneaLabs\CashierPaypal\Tests\Fixtures\User']);
