...
use GeneaLabs\CashierPaypal\Events\MandateClearedFromBillable;
...
use GeneaLabs\CashierPaypal\Traits\PopulatesMollieCustomerFields;
...
trait Billable
{
     ...
     * @return \GeneaLabs\CashierPaypal\Subscription|null
     */
     ...
     * @param string $subscription
     * @param string $plan
     * @return \GeneaLabs\CashierPaypal\SubscriptionBuilder\Contracts\SubscriptionBuilder
     ...
     * @param $subscription
     * @param $plan
     * @return \GeneaLabs\CashierPaypal\SubscriptionBuilder\FirstPaymentSubscriptionBuilder
     * @throws \GeneaLabs\CashierPaypal\Exceptions\PlanNotFoundException
     */
    ...
    /**
     * @return \GeneaLabs\CashierPaypal\Billable
     */
