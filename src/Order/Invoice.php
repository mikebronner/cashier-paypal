...
use GeneaLabs\CashierPaypal\Order\Contracts\InvoicableItem;
use GeneaLabs\CashierPaypal\Traits\FormatsAmount;
use Money\Money;
...
class Invoice
{
    ...
    /**
     * @param \GeneaLabs\CashierPaypal\Order\Contracts\InvoicableItem $item
     * @return $this
     */
