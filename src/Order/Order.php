...
use GeneaLabs\CashierPaypal\Events\BalanceTurnedStale;
use GeneaLabs\CashierPaypal\Events\OrderCreated;
use GeneaLabs\CashierPaypal\Events\OrderPaymentFailed;
use GeneaLabs\CashierPaypal\Events\OrderPaymentPaid;
use GeneaLabs\CashierPaypal\Events\OrderProcessed;
use GeneaLabs\CashierPaypal\Exceptions\InvalidMandateException;
use GeneaLabs\CashierPaypal\MandatedPayment\MandatedPaymentBuilder;
use GeneaLabs\CashierPaypal\Order\Contracts\MinimumPayment;
...
class Order extends Model
{
     ...
     * @param $item
     * @param array $overrides
     * @return \GeneaLabs\CashierPaypal\Order\Order
     */
     ...
     *
     * @return $this
     * @throws \GeneaLabs\CashierPaypal\Exceptions\InvalidMandateException
     */
     ...
     * @param null $id
     * @param null $date
     * @return \GeneaLabs\CashierPaypal\Order\Invoice
     */
