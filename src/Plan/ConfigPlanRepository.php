...
namespace GeneaLabs\CashierPaypal\Plan;

use Illuminate\Support\Str;
use GeneaLabs\CashierPaypal\Exceptions\PlanNotFoundException;
use GeneaLabs\CashierPaypal\Order\OrderItemPreprocessorCollection as Preprocessors;
...
class ConfigPlanRepository implements PlanRepository
{
    ...
    /**
     * @return \GeneaLabs\CashierPaypal\Plan\PlanCollection
     */
