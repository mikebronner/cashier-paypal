...
namespace GeneaLabs\CashierPaypal\SubscriptionBuilder;

use Carbon\Carbon;
use Illuminate\Database\Eloquent\Model;
use GeneaLabs\CashierPaypal\FirstPayment\Actions\ActionCollection;
use GeneaLabs\CashierPaypal\FirstPayment\Actions\AddGenericOrderItem;
use GeneaLabs\CashierPaypal\FirstPayment\Actions\ApplySubscriptionCouponToPayment;
use GeneaLabs\CashierPaypal\FirstPayment\Actions\StartSubscription;
use GeneaLabs\CashierPaypal\FirstPayment\FirstPaymentBuilder;
use GeneaLabs\CashierPaypal\Plan\Contracts\PlanRepository;
use GeneaLabs\CashierPaypal\Plan\Plan;
use GeneaLabs\CashierPaypal\SubscriptionBuilder\Contracts\SubscriptionBuilder as Contract;
...
{
    /**
     * @var \GeneaLabs\CashierPaypal\FirstPayment\FirstPaymentBuilder
     */
    protected $firstPaymentBuilder;

    /**
     * @var \GeneaLabs\CashierPaypal\FirstPayment\Actions\StartSubscription
     */
     ...
     *
     * @return \GeneaLabs\CashierPaypal\SubscriptionBuilder\RedirectToCheckoutResponse
     * @throws \GeneaLabs\CashierPaypal\Exceptions\CouponException|\Throwable
     */
    ...
    /**
     * @return \GeneaLabs\CashierPaypal\FirstPayment\FirstPaymentBuilder
     */
