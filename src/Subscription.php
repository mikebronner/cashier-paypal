...
use GeneaLabs\CashierPaypal\Order\Contracts\PreprocessesOrderItems;
...
use GeneaLabs\CashierPaypal\Events\SubscriptionCancelled;
use GeneaLabs\CashierPaypal\Events\SubscriptionPlanSwapped;
use GeneaLabs\CashierPaypal\Events\SubscriptionQuantityUpdated;
...
use GeneaLabs\CashierPaypal\Plan\Contracts\Plan;
use GeneaLabs\CashierPaypal\Plan\Contracts\PlanRepository;
use GeneaLabs\CashierPaypal\Traits\HasOwner;
use GeneaLabs\CashierPaypal\Types\SubscriptionCancellationReason;
use LogicException;
use Money\Money;
...
class Subscription extends Model implements InteractsWithOrderItems, PreprocessesOrderItems, AcceptsCoupons
{
     ...
     *
     * @param \GeneaLabs\CashierPaypal\Plan\Contracts\Plan $plan
     ...
     *
     * @return \GeneaLabs\CashierPaypal\Plan\Plan
     */
     ...
     * @param int $count
     * @param bool $invoiceNow
     * @return \GeneaLabs\CashierPaypal\Subscription
     * @throws \Throwable
     */
    ...
    /**
     * @param \Carbon\Carbon|null $now
     * @return null|\GeneaLabs\CashierPaypal\Order\OrderItem
     */
